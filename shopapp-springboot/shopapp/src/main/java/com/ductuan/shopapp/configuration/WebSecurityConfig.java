package com.ductuan.shopapp.configuration;

import com.ductuan.shopapp.filter.JwtTokenFilter;
        ...
        http
                ...
                .authorizeHttpRequests(requests -> {
                    requests
                            ...
                            .requestMatchers(POST, String.format("%s/orders_details/**", apiPrefix)).hasAnyRole(Role.USER)
                            .requestMatchers(GET, String.format("%s/orders_details/**", apiPrefix)).permitAll()
                            .requestMatchers(PUT, String.format("%s/orders_details/**", apiPrefix)).hasRole(Role.ADMIN)
                            .requestMatchers(DELETE, String.format("%s/orders_details/**", apiPrefix)).hasRole(Role.ADMIN)
